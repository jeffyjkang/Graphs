...
# def dftr(rooms, position, visited):
#     print('****')
#     print(f'rooms: {rooms}')
#     print(f'players current room: {position.currentRoom}')
#     print(f'graph: {visited}')
#     #
#     possible_exits = position.currentRoom.getExits()
#     possible_exits = {i: '?' for i in possible_exits}
#     visited[position.currentRoom.id] = possible_exits
#     print(f'visited: {visited}')
#     print(visited.keys())
#     print(rooms[position.currentRoom.id][1])

    # print("S")
    # print(position.currentRoom.n_to)
    # print(position.travel('n'))
    # print(position.currentRoom)
    # print("S")
    # if room not in visited.keys():
    #         # print(room)
    #     if position.currentRoom.n_to:
    #         position.travel('n')
    #         new_position = position
    #     if position.currentRoom.s_to:
    #         position.travel('s')
    #         new_position = position
    #     if position.currentRoom.w_to:
    #         position.travel('w')
    #         new_position = position
    #     if position.currentRoom.e_to:
    #         position.travel('e')
    #         new_position = position
    #     dftr(rooms, new_position, visited)
    #     if nieghbor not in visited.keys()
    # print(visited)

    # return visited
    # def helper(rooms,position,visited):
...
# def dft(rooms, position, visited):
#     # create a stack
#     stack = Stack()
#     # print(rooms)
#     # assign the graph[currentroom] key to empty object
#     visited = visited
#     # print(position.currentRoom.id)
#     # print(position.currentRoom)
#     # push current room into stack
#     stack.push(position.currentRoom.id)
...
#         print(f'visited: {visited}')
#         # if vertex not in visited:
#         print(f'visited vertex: {visited[vertex]}')

#         for direction in visited[vertex]:
#             print(f'direction:{direction}')
#             if visited[vertex][direction] == '?':

#                 # if visited[vertex]['n'] == '?' or visited[vertex]['s'] == '?' or visited[vertex]['w'] == '?' or visited[vertex]['e'] == '?':

#                 # if visted graph at currentrooms id at index of either n s w e is == ? move on
...
#                     # while position.currentRoom.n_to:
#                     previousRoom = position.currentRoom.id
#                     position.travel('n')
#                     visited[previousRoom]['n'] = position.currentRoom.id
#                     # print(position.currentRoom.getExits())
#                     # print(visited)
#                     # print(position.currentRoom)
#                     visited[position.currentRoom.id] = {}
#                     for exit in position.currentRoom.getExits():
#                         # print(f'exit: {exit}')
#                         visited[position.currentRoom.id][exit] = '?'
...
#                     previousRoom = position.currentRoom.id
#                     position.travel('s')
#                     visited[previousRoom]['s'] = position.currentRoom.id
#                     # print(position.currentRoom.getExits())
#                     # print(visited)
#                     # print(position.currentRoom)
#                     visited[position.currentRoom.id] = {}
...
#                     previousRoom = position.currentRoom.id
#                     position.travel('w')
#                     visited[previousRoom]['w'] = position.currentRoom.id
#                     # print(position.currentRoom.getExits())
#                     # print(visited)
#                     # print(position.currentRoom)
#                     visited[position.currentRoom.id] = {}
...
#                     previousRoom = position.currentRoom.id
#                     position.travel('e')
#                     visited[previousRoom]['e'] = position.currentRoom.id
#                     # print(position.currentRoom.getExits())
#                     # print(visited)
#                     # print(position.currentRoom)
#                     visited[position.currentRoom.id] = {}
...
# new_position = dft(roomGraph, player, graph)
# print(new_position)
...
# if the room doesn't exist, initialize your room graph with '?' exits
...
# update the graph entry for the current and previous room
# if there is an unexplored exit in the current room (i.e a '?' exit), travel in that direction
# else, find the nearest room with tan unexplored exit and travel there
...
# print(find_nearest_unexplored(graph, player.currentRoom.id))
